  ...
  return (
    ...
    >
      <div className="w-1/2 " style={{ borderColor: "#006991" }}>
        ...
        <div className="h-72 w-72 ">
          <img
            src="/public/ur.jpg"
            alt="Ur-logo"
            className="w-full h-full object-contain mt-15 ml-9"
          />
        </div>
      </div>
      ...
      >
        ...
        <button className="p-2 w-full bg-transparent text-white mt-5 border-1 border-white hover:bg-cyan-50/30 rounded-lg ">
          Reset Password
        </button>
      </form>
